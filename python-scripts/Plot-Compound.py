...
ax1.plot(T_prueba1, error_list, label = "TRE")                                       # Plotting curve of temperatures
ax1.scatter(Tc, error_list[pos_min1], color = (1., 0.5, 0.5), s = 100, label = "Tc") # Plot of the minimum
...
im = ax2.imshow(100*error_matrix, origin="lower", cmap="inferno", vmin=0, interpolation="bilinear") # Plot of the heat map
...
# Box of text
ax2.text((length-1)/2, 0.68*(length-1), "\nRelative Error = {:.4f} %\n Luminosity = {:.4f}·10^33 erg s^−1 \nRadius = {:.4f}·10^10 cm\n"

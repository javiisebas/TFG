...
def frontierStudy(part):
    ...
    if part == 2: # Part two of the calculations
        ...
        R_int = [RTot_initial-0.7, RTot_initial+0.5]     # Radius interval boundaries
        L_int = [LTot_initial-5, LTot_initial+5]         # Luminosity interval boundaries
        ...
        for i in range(length): # Rows
            if (100*(i+1)/length) % 25 == 0: # Progress Percentaje

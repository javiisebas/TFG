...
ax.plot(T_prueba1, error_list, label = "Rel Error(T)")                                    # Plotting curve of temperatures
ax.scatter(Tc, error_list[pos_min1], color = (1., 0.5, 0.5), s = 100, label = "T center") # Plot of the minimum
